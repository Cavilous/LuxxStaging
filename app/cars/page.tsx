...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://luxxmiami.com/cars",
    type: "website",
  },
  alternates: {
    canonical: "https://luxxmiami.com/cars",
  },
}
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Exotic Cars', url: 'https://luxxmiami.com/cars' },
        ]}
      />
      <section className="relative bg-[#0A0A0A] hero-angled-bottom">
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-3xl leading-relaxed">
            Experience Miami in unparalleled style with our curated collection of exotic supercars, luxury sedans, and high-performance vehicles. From Ferrari and Lamborghini to Rolls-Royce and Mercedes, drive the car of your dreams. For additional{" "}
            <a href="https://luxmiami.com/cars-rental-miami" target="_blank" rel="noopener" className="text-[#ECAC36] hover:underline">exotic car rentals in Miami</a>, including{" "}
            <a href="https://luxmiami.com/exotic-car-rental-miami-airport" target="_blank" rel="noopener" className="text-[#ECAC36] hover:underline">airport concierge delivery to Miami and Fort Lauderdale</a>, our partner Lux Miami offers a complementary fleet.
          </p>
        </div>
      </section>
