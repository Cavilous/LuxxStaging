...
import { importVillasFromCSV } from "@/lib/import-actions"
...
export function ImportVillasClient() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      setProgress("Parsing villa data and fetching images...")
      
      const result = await importVillasFromCSV(text)
      ...
      <Card className="bg-[#111111] border-[#333333] cut-corner">
        ...
        <CardContent className="text-gray-400 space-y-2">
          ...
          <div className="bg-[#0A0A0A] p-4 cut-corner font-mono text-sm">
            Title, Location, Bedrooms, Bathrooms, Guests, Price, Security Deposit, Cleaning Fee, Image Links
          </div>
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Title:</strong> Villa name (e.g., "Sunset Villa")</li>
            <li><strong>Location:</strong> Area/neighborhood (e.g., "Miami Beach")</li>
            <li><strong>Bedrooms:</strong> Number of bedrooms (e.g., 5)</li>
            <li><strong>Bathrooms:</strong> Number of bathrooms (e.g., 4.5)</li>
            <li><strong>Guests:</strong> Max guest capacity (e.g., 12)</li>
            <li><strong>Price:</strong> Nightly rental price (e.g., 2500 or "price upon request")</li>
            <li><strong>Security Deposit:</strong> Amount (e.g., 5000)</li>
            <li><strong>Cleaning Fee:</strong> Amount (e.g., 500)</li>
